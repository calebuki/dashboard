  ...
  return (
    ...
    >
      <SquircleSegment
        ...
        className="bg-[#F4F4F9] dark:bg-[#262626] h-12 flex items-center gap-1 pl-2"
      >
        <DurationField
          value={hoursText}
        ...
        />
        <motion.span style={{ x: swayX }} className="text-[#868593]/70 font-semibold font-runde">
          {hoursLabel}
        </motion.span>
      </SquircleSegment>
      <SquircleSegment
        ...
        className="bg-[#F4F4F9] dark:bg-[#262626] h-12 flex items-center gap-1"
      >
        <DurationField
          value={minutesText}
          ...
          swayX={swayX}
        />
        <motion.span style={{ x: swayX }} className="text-[#868593]/70 font-medium font-runde">
          {minutesLabel}
        </motion.span>
      </SquircleSegment>
      <SquircleSegment
